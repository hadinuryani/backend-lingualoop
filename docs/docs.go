...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/academic_year.TemplateResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/region.CityResponse"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/region.DistrictResponse"
                                            }
                                        }
                                    }
                                }
        ...
        "/region/districts/{id}/subdistricts": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search subdistrict by name",
                        "name": "search",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/region.SubdistrictResponse"
                                            }
                                        }
                                    }
                                }
        ...
        "/region/postal-codes/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Postal code to search (min 3 chars)",
                        "name": "code",
                        "in": "query",
                        "required": true
                    }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/region.PostalCodeResponse"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/region.ProvinceResponse"
                                            }
                                        }
                                    }
                                }
        ...
        "/region/subdistricts/{id}/postal-codes": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "academic_year.TemplateResponse": {
            "type": "object",
            "properties": {
                "source_year": {
                    "type": "string"
                ...
                "template": {
                    "$ref": "#/definitions/academic_year.TemplateData"
                }
            }
        },
        "auth.LoginRequest": {
        ...
        "class.ClassRequest": {
            ...
            "properties": {
                ...
                "class_name": {
                    "description": "Otomatis dibentuk backend, tapi field dipertahankan jika frontend masih mengirim",
                    "type": "string"
                },
                "class_number": {
                    "type": "integer",
